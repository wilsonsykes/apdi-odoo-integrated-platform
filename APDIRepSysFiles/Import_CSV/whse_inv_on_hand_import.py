...
# CSV file path
CSV_FILE_PATH = r"C:\Users\OP5\Desktop\APDIRepSysFIles\Import_CSV\whse_inv_on_hand_import.csv"

# PostgreSQL table name
TABLE_NAME = "whse_inv_on_hand"

# Define actual column names (excluding 'id' since it's auto-incremented)
DB_COLUMNS = ["product", "whse_name", "whse_location", "qty_on_hand"]
